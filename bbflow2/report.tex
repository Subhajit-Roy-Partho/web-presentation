...
Published feasibility data support the premise: IDRome provides proteome-scale IDP
trajectories, CALVADOS2 captures sequence-dependent IDP compactness, and BBFlow shows that
SE(3) flow matching can learn protein ensemble distributions orders of magnitude faster than
MD for folded proteins.
...
a sequence-predicted mean $R_g$ is used to scale the translational noise variance, so that
